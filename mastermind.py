...
def game_answer():
    ...
    colourChoice1 = colourChoice[0:(colours)]#choice how many colour we will use
    colourChoice2 = colourChoice1[:]
    for i in range (0, pegs):
        i = random.choice(colourChoice1)
        colourChoice1.remove(i)#This is because we could not have repeat colour
        gameAnswer.append(i)
    #print gameAnswer  
...
def check_Answer():
    ...
    for i in range (0, pegs):#count the black number
    ...
    for element in userGuess2:
        if element in userGuess2[c+1:len(userGuess2)]:
            userGuess2[c] = 1
        c += 1
    for i in range (0, pegs):#count the white number
    ...
    if black == pegs: #!!WIN!!
        ...
        if choice == 0:#this is used for player
            i = 1
        ...
        else: #this is used for computer codemaker vs computer codebreaker
    ...
    #show the answer on the gameboard
        i = 1
        if choice == 0:
            whiteBoard.append(white)
            blackBoard.append(black)
