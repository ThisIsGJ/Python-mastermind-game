#The previous file is the main file call'mastermind'.
#I have no enough time to finish the graphical interface. But I have basically finish the frame. 
#You could run the program below.The menus shows on the top.
...
# Grid values for horizontal and vertical
Horiz = 7
Vert = 10
